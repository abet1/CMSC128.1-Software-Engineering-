...
export default function EditGroupPage() {
  ...
  const { groups, persons, updateGroup } = useApp();
      ...
      <div className="px-4 lg:px-8 py-4 lg:py-6">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="font-display text-2xl lg:text-3xl font-bold text-foreground">Edit Group</h1>
              <p className="text-sm text-muted-foreground mt-1">Update group information</p>
            </div>
          </div>
